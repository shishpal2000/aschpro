...
const TermsContent = () => {
  return (
    <div className="container mt-5">
      ...
      <p>Welcome to aschpro!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of aschpro&apos;s Website, located at https://aschpro.com/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use aschpro if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing aschpro, you agreed to use
        cookies in agreement with the aschpro&apos;s Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, aschpro and/or its licensors own the
        intellectual property rights for all material on aschpro. All
        intellectual property rights are reserved. You may access this from
        aschpro for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from aschpro</li>
        <li>Sell, rent or sub-license material from aschpro</li>
        <li>Reproduce, duplicate or copy material from aschpro</li>
        <li>Redistribute content from aschpro</li>
      </ul>

      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        aschpro does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of aschpro, its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, aschpro shall not be liable for the
      ...
      <p>
        aschpro reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant aschpro a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of aschpro; and (d) the link is in
      ...
      <p>
        ...
        e-mail to aschpro. Please include your name, your organization name,
      ...
      <p>
        No use of aschpro&apos;s logo or other artwork will be allowed for linking
