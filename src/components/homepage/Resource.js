  ...
  return (
    ...
    >
      <div className={styles.positionRelative}>
        ...
        <img src={`https://ad.aschpro.com/storage/${image}`} alt={imgalt} className={styles.blogImg} />
...
const Resource = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('https://ad.aschpro.com/api/homeblogs'); // Replace with your API endpoint
        if (!response.ok) {
