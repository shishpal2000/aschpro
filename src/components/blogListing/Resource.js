...
const Resource = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('https://admin.aschpro.com/api/blogs'); // Replace with your API endpoint
        if (!response.ok) {
    ...
    return (
      <div className={styles.blueBox}>
        <div className={styles.positionRelative}>
          ...
          <img src={`https://admin.aschpro.com/storage/${image}`} alt={imgalt} className={styles.blogImg} width={300} height={200} />
