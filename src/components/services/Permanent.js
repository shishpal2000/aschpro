          ...
          >
            <div className={styles.center_11}>
              ...
              <p className={style.greyText1}>
                We the permanent staffing agency follows upskills to exaggerate
                their talents which contributes to enhancing the workforce and
                productivity.It helps the organisation cope with uncertain risks
                upskilling the talent acquisition services
              </p>
              <p className={style.greyText1}>
              ...
              <div
                ...
                onClick={() => router.push("/permanent-staffing")}
              >
