      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-12">
            <h3 className={styles.main_heading}>Learn about Permanent Staffing</h3>
            ...
            {readMore ? (
              <div className={styles.readMore_heading}>
                ...
                <h2 className={styles.sub_heading}>A Partnership with a Growing Tech Firm</h2>
                ...
                <h2 className={styles.sub_heading}>Comprehensive Talent Acquisition Strategy</h2>
                ...
                <h2 className={styles.sub_heading}>Rigorous Selection Process</h2>
                ...
                <h2 className={styles.sub_heading}>Seamless Onboarding and Integration</h2>
                ...
                <h2 className={styles.sub_heading}>Long-Term Success and Growth</h2>
