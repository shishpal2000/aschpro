...
const PrivacyContent = () => {
  return (
    <div className="container mt-5">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to aschpro, Plot No 83, Sainath colony,
            Panama Godowns, Vanasthalipuram, Hyderabad 500 070.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to aschpro, accessible from{" "}
            <a
              href="https://aschpro.com/"
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            items or services You have purchased or of any other contract with
      ...
      <ul>
        <li>
          <p>By email: hr@aschpro.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://aschpro.com/contact_us"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://aschpro.com/contact_us
            </a>
          </p>
        </li>
      </ul>
