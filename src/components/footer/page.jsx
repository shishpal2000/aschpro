  ...
  return (
    <footer className={styles.footer}>
      <div className="container">
        <div className="row">
          <div className="col-lg-5 col-md-6 col-sm-6">
            ...
            {phoneResponsive ? (
              <p className={`${styles.p}`}>
                AschPro believes that the consistent and innovative use of
                transparency and integrity sets us apart as a recruitment
                partner.
              </p>
            ) : (
              <p className={`${styles.p} mt-4 ml-2 ${styles.widthValue}`}>
                AschPro believes that the consistent and innovative use of
                transparency and integrity sets us apart as a recruitment
                partner.
              </p>
          ...
          <div className="col-lg-2 col-md-6 col-sm-6">
            ...
            <ul className={styles.list}>
              <li
                className={`py-2 d-flex align-items-center ${styles.listItem}`}
              >
                <a href="/">
                  <Image
                    src={play}
        ...
        <div
          className={`d-flex justify-content-between ${styles.pdCustomOne} ${styles.borderTop}`}
        >
          <div>
            <p className={styles.yellowText}>
              © 2024 Aschpro Inc. All rights reserved.
            </p>
          </div>
          <div className="d-flex justify-content-between">
            ...
            >
              {" "}
              © Created and maintained by Media Dynox.
            </p>
